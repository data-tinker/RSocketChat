...
class PersistentMessageService(val messageRepository: MessageRepository) : MessageService {
    ...
    override fun latest(): Flow<MessageVM> = messageRepository.findLatest()
        .mapToViewModel()

    override fun after(messageId: String): Flow<MessageVM> = messageRepository.findLatest(messageId)
        .mapToViewModel()
